...
<body>
    ...
    <div class="container mt-4">
        ...
        <button class="btn btn-primary" onclick="location.href='add-loan.jsp'">Add Loan</button>
        <button class="btn btn-secondary" onclick="location.href='view-loans.jsp'">View Loans</button>
        <button class="btn btn-danger" onclick="location.href='delete-loan.jsp'">Delete Loan</button>
    </div>
</body>
</html>
