...
<body>
    ...
    <div class="container mt-4">
        ...
        <button class="btn btn-primary" onclick="location.href='view-fines.jsp'">View Fines</button>
        <button class="btn btn-warning" onclick="location.href='update-fine.jsp'">Update Fine</button>
        <button class="btn btn-danger" onclick="location.href='clear-fine.jsp'">Clear Fine</button>
    </div>
</body>
</html>
